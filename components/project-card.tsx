            ...
            <CardBody>
              ...
              {(() => {
                ...
                const knownColorMap: Record<string, { bg: string; text: string }> = {
                  "emerald-400": { bg: "bg-emerald-400", text: "text-white" },
                  "amber-400": { bg: "bg-amber-400", text: "text-white" },
                  "sky-400": { bg: "bg-sky-400", text: "text-white" },
                  "indigo-400": { bg: "bg-indigo-400", text: "text-white" },
                };
                ...
                const btnClass = `inline-flex items-center gap-2 px-3 py-1.5 text-sm font-medium rounded-md ${buttonBg} ${buttonText} hover:opacity-95`;
